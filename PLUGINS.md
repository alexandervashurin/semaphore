...
> **Система плагинов для расширения функциональности СЕМАФОРЪ**
...
Система плагинов позволяет расширять функциональность СЕМАФОРЪ без изменения основного кода приложения.
