...
Система WASM плагинов позволяет динамически загружать и выполнять код плагинов без перекомпиляции основного приложения Semaphore UI.
