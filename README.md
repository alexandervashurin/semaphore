...
|-----------|--------|----------------|--------|
| **Утилиты** | mailer, encryption, shell | 402 → 622 | ✅ 100% |
...
| Категория | Файл | Строк | План декомпозиции |
|-----------|------|-------|-------------------|
| **util/config** | config.go | 1,407 | [План](util/CONFIG_DECOMPOSITION.md) (10 модулей) |
| **db/sql** | SqlDb.go | 982 | В плане |
| **db/sql** | template.go | 509 | В плане |
| **db/sql** | user.go | 411 | В плане |
| **db/sql** | task.go | 403 | В плане |
| **db/sql** | integration.go | 340 | В плане |
| **services/tasks** | TaskPool.go | 752 | В плане |
| **services/tasks** | TaskRunner.go | 439 | В плане |
| **services/export** | остальные модули | ~2,100 | [План](services/export/EXPORTER_DECOMPOSITION.md) |
