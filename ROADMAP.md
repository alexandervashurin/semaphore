...
- ✅ Отправлено в origin/main (8 коммитов)
...
- ✅ **P1-3: Export/Import маппинг ключей** — ЗАВЕРШЕНА
  - Добавлены поля в ExporterChain для маппинга
  - Реализованы методы KeyMapper для строковых и integer ключей
  - Добавлен конструктор with_options() для настройки
