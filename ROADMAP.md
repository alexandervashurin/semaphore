...
- ✅ Отправлено в origin/main (9 коммитов)
...
- ✅ **P1-4: Улучшение CLI** — ЗАВЕРШЕНА
  - Реализована команда `migrate --upgrade`
  - Реализована команда `setup` с инструкциями
  - Улучшена команда `runner`
