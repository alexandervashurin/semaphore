...
mod tests {
    ...
    use crate::models::organization::{
        OrganizationCreate, OrganizationUpdate, OrganizationUserCreate,
    };
    ...
    async fn test_create_organization_auto_slug() {
        ...
        let org = store
            .create_organization(create_org_create("My Organization"))
            .await
            .unwrap();
    ...
    async fn test_get_organization_found() {
        let store = MockStore::new();
        store
            .create_organization(create_org_create("Test"))
            .await
            .unwrap();
    ...
    async fn test_get_organization_by_slug() {
        let store = MockStore::new();
        store
            .create_organization(create_org_create("Test Org"))
            .await
            .unwrap();
    ...
    async fn test_update_organization() {
        let store = MockStore::new();
        store
            .create_organization(create_org_create("Old Name"))
            .await
            .unwrap();
    ...
    async fn test_delete_organization() {
        let store = MockStore::new();
        store
            .create_organization(create_org_create("ToDelete"))
            .await
            .unwrap();
    ...
    async fn test_update_user_organization_role() {
        ...
        store
            .update_user_organization_role(1, 1, "admin")
            .await
            .unwrap();
        let users = store.get_organization_users(1).await.unwrap();
    ...
    async fn test_get_user_organizations() {
        let store = MockStore::new();
        store
            .create_organization(create_org_create("Org1"))
            .await
            .unwrap();
        store
            .create_organization(create_org_create("Org2"))
            .await
            .unwrap();
        store
            .add_user_to_organization(OrganizationUserCreate {
    ...
    async fn test_check_quota_users_no_limit() {
        let store = MockStore::new();
        store
            .create_organization(create_org_create("NoQuota"))
            .await
            .unwrap();
    ...
    async fn test_multiple_organizations() {
        ...
        for name in &["Alpha", "Beta", "Gamma"] {
            store
                .create_organization(create_org_create(name))
                .await
                .unwrap();
        }
