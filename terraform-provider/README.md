# Velum Terraform Provider

Manage [Velum](https://github.com/alexandervashurin/semaphore) resources via Terraform.
...
data "velum_template" "deploy" {
  project_id = data.velum_project.main.id
  name       = "Deploy to Production"
}

# Create a new template
resource "velum_template" "backup" {
  project_id = data.velum_project.main.id
...
resource "velum_access_key" "ssh_key" {
  project_id = data.velum_project.main.id
  name       = "Deploy Key"
  type       = "ssh"
